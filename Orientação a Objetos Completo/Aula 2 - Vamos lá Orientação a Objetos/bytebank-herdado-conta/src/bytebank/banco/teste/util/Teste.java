...
public class Teste {
    public static void main(String[] args) {
        ...
        //Function Object -> Objetos para encapsular algum método, só existe para um método funcionar
...
//          Integer.compare(c1.getNumero(), c2.getNumero()));
        ...
        lista.sort(Comparator.comparingInt(Conta::getNumero)); // forma mais enxuta
